...
class VOCAnnotationTransform(object):
    ...
    def __call__(self, target, width, height):
        ...
        return res # [[xmin, ymin, xmax, ymax], ... ]
...
class VOCDetection(data.Dataset):
    ...
    Arguments:
        ...
        transform (callable, optional): transformation to perform on the 
            input image
        target_transforms (callable, optional): transformation to perform on the
            target 'annotaion'
            (eg. take in caption string, return tensor of word indicex)
    ...
    def __init__(self,
        ...
        self.ids = list() # [[rootpath, img_name], ... ]
    ...
    def pull_item(self, index):
        ...
        img = cv2.imread(self._imgpath % img_id) # bgr
...
if __name__ == '__main__':
    ...
    data_root = r'C:\Users\Coco\Desktop\YOLOv1\VOC0712\VOCdevkit'
